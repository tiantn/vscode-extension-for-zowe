...
function initDatasetProvider(context: vscode.ExtensionContext, datasetProvider: IZoweTree<IZoweDatasetTreeNode>) {
    ...
    vscode.commands.registerCommand("zowe.uploadFromJsonDialog", (node) =>
        dsActions.uploadFromJsonDialog(node, datasetProvider)
    );
    vscode.commands.registerCommand("zowe.uploadFromJsonTemplate", (node) =>
        dsActions.uploadFromJsonDialog(node, datasetProvider, true)
    );
    vscode.commands.registerCommand("zowe.createTemplate", (node) => dsActions.createTemplate(node, datasetProvider));
